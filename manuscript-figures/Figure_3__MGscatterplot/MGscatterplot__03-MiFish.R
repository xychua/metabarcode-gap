...
##
## Plot MG scatter plot for MiFish primer pair
##
## __________
##   Author: Xin-Yi Chua
##
...
abs.limits[interest == T & intra.minP < 80 & inter.maxP > 90, show.lbl:=query.species]
abs.limits[interest == T & intra.minP < 100 & inter.maxP < 80, show.lbl:=query.species]
abs.limits[interest == T & MG.type == 'gap' &
             intra.minP %between% c(85,95) & 
             inter.maxP %between% c(80,90), show.lbl:=query.species]
