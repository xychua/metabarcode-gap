...
![Example of a metabarcoding gap (MG) scatter plot showing the teleo in silico amplicon data. Figure is generated using the example-01__MG-scatterplot.R script.](../figures/teleo_MG-scatterplot.png =800x800)
...
![Example of the MG histogram for Bagarius yarrelli species of interest of the data set targeted by the teleo primer pair. Figure is generated using the example-02__MG-histogram.R script.](../figures/teleo_MG-histogram.png =400x800)
...
![Example of the MG heatmap for Bagarius yarrelli species of interest of the data set targeted by the teleo primar pair. Figure is generated using the example-03__MG-heatmap.R script.](../figures/teleo_MG-heatmap.png =400x800)
